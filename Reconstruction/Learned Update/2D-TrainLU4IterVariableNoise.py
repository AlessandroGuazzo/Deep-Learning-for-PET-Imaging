...
# THIS CODE CONTINUES OR STARTS THE TRAINING OF A LEARNED UPDATE ALGORITHM FOR PET IMAGE RECONSTRUCTION

# THE CODE IS USED TO TRAIN THE 4 ITERATION ALGORITHM STARTING FROM THE 3 ITERATION ONE ACCORDING TO THE PROGRESSIVE LEARNING STRATEGY
...
numTrain = 100000 # CHANGE HERE TRAINING SET SIZE
...
# INITIALIZE NEW LAYER WITH XAVIER INITIALIZATION

Unet4.apply(weight_init)

# LEARNED UPDATE ALGORITHM DEFINITION

def LU(Unet1,Unet2,Unet3,Unet4,sino,normalization,see):
        ...
        out1 = Unet3(torch.cat((x1,diff_img1),dim=1))
        ...
        out2 = Unet4(torch.cat((x2,diff_img2),dim=1))
...
def train(epoch):
    ...
    for batch_idx,images in enumerate(train_loader): 
        ...
        x3 = LU(Unet1,Unet2,Unet3,Unet4,trainSino,normalisation,False)
...
def test(): 
    ...
    for batch_idx,test_im in enumerate(test_loader):
        ...
        x3 = LU(Unet1,Unet2,Unet3,Unet4,testSino,normalisation,False)
...
if use_checkpoint:
    ...
    try:
        checkpoint = torch.load('LearnedUpdate3Iter.tar')
